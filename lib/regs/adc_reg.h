...
#define ADC1_DBRH(n) MMIO32(ADC1_BASE + n*2)
#define ADC1_DB0RH  MMIO32(ADC1_BASE + 0x00)
#define ADC1_DB1RH  MMIO32(ADC1_BASE + 0x02)
#define ADC1_DB2RH  MMIO32(ADC1_BASE + 0x04)
#define ADC1_DB3RH  MMIO32(ADC1_BASE + 0x06)
#define ADC1_DB4RH  MMIO32(ADC1_BASE + 0x08)
#define ADC1_DB5RH  MMIO32(ADC1_BASE + 0x0a)
#define ADC1_DB6RH  MMIO32(ADC1_BASE + 0x0c)
...
#define ADC1_DBRL(n) MMIO32(ADC1_BASE + (n*2)+1)
#define ADC1_DB0RL  MMIO32(ADC1_BASE + 0x01)
#define ADC1_DB1RL  MMIO32(ADC1_BASE + 0x03)
#define ADC1_DB2RL  MMIO32(ADC1_BASE + 0x05)
#define ADC1_DB3RL  MMIO32(ADC1_BASE + 0x07)
#define ADC1_DB4RL  MMIO32(ADC1_BASE + 0x09)
#define ADC1_DB5RL  MMIO32(ADC1_BASE + 0x0b)
#define ADC1_DB6RL  MMIO32(ADC1_BASE + 0x0d)
